...
urlpatterns = [
    ...
    path('toggle_availability/<int:pk>/', views.toggle_availability, name='toggle_availability'),
    ...
    path('approve_chore_claim/<int:pk>/<int:penalty>/', views.approve_chore_claim, name='approve_chore_claim'),
    path('reject_chore_claim/<int:pk>/', views.reject_chore_claim, name='reject_chore_claim'),

    path('point_adjustment/<int:pk>/', views.point_adjustment, name='point_adjustment'),
    path('pocket_money_adjustment/<int:pk>/', views.pocket_money_adjustment, name='pocket_money_adjustment'),
    path('convert_points_to_money/<int:pk>/', views.convert_points_to_money, name='convert_points_to_money'),
