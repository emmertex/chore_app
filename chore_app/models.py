...
class ChoreClaim(models.Model):
    chore = models.ForeignKey(
        Chore, on_delete=models.CASCADE, blank=True, null=True, default=None)
    choreName = models.CharField(max_length=255, default="")
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='user_choreclaim')
...
class PointLog(models.Model):
    ...
    approver = models.ForeignKey(User, on_delete=models.CASCADE,
                                 null=True, blank=True, related_name='approver_pointlogs')
